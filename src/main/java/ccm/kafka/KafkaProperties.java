...
public class KafkaProperties {
    ...
    private final KafkaProperties.Retry retry = new KafkaProperties.Retry();
    ...
    public static class Consumer {
        ...
        public Map<String, Object> buildProperties() {
            KafkaProperties.Properties properties = new KafkaProperties.Properties();
    ...
    public static class Streams {
        ...
        private final KafkaProperties.Cleanup cleanup = new KafkaProperties.Cleanup();
    ...
    public static class Listener {
        ...
        /**
         * Time between checks for non-responsive consumers in seconds.
         */
        ...
        public KafkaProperties.Listener.Type getType() {
            return this.type;
        }

        public void setType(KafkaProperties.Listener.Type type) {
            this.type = type;
        }
    ...
    public static class Retry {
        ...
        private final KafkaProperties.Retry.Topic topic = new KafkaProperties.Retry.Topic();

        public KafkaProperties.Retry.Topic getTopic() {
            return this.topic;
        }
    ...
    private static class Properties extends HashMap<String, Object> {
        ...
        KafkaProperties.Properties with(KafkaProperties.Ssl ssl, KafkaProperties.Security security, Map<String, String> properties) {
